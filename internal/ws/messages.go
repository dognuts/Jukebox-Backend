...
const (
	...
	// EventInitialState opens the per-client initial replay and carries
	// a top-level "serverTime" field (unix epoch ms at send time) that
	// clients use to compute their clock offset. See Hub.sendInitialState.
